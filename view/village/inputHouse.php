...
<body>
	...
	<script type="text/javascript">
		...
		document.getElementById('inputHouse').setAttribute('class','active');
	</script>

	<div class="container">
   			<p style="color:red;font-size:8px;">一次录入操作数量请勿超过1000条</p>
    <table class="table table-hover">
      <form role="form" method="POST" action=<?php echo __PUBLIC__.'/control/villageControl.php?method=inputHouse&id='.$_SESSION['estateManager']['villageId'];?> id="content">
        <tbody>
          <col width="20%"></col>
          <col width="80%"></col>
          <tr>
